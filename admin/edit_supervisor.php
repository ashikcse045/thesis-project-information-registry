...
<?php
    ...
    {
        $id = $_GET['id'];
        $sql = "select * from supervisor where emp_id = '$id'";
                ...
                <div class="form_div">
                    <form action="" method="POST">
                        ...
                        <div class="box">
                            ...
                            <input type="text" name="sName" id="sName" placeholder="short name" value="<?php echo isset($sName) ? $sName : '' ?>">
                            <p><?php echo isset($s_er) ? $s_er : '' ?></p>
                        </div>
                        ...
                        <div class="box">
                            ...
                            <input type="text" name="emp_id" id="emp_id" placeholder="employee id" value="<?php echo isset($emp_id) ? $emp_id : '' ?>">
                        ...
                        <div class="box btn">
                            ...
                            <input type="submit" name="update" id="add" value="add">
                        </div>
