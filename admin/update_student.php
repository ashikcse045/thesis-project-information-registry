...
<head>
    ...
    <title>Update student info</title><link rel="icon" type="image/x-icon" href="../favicon.ico">
    ...
    <div class="container">
        ...
        <div class="content">
            <div class="content_box">
                ...
                <div class="form_div">
                    <h4 style="margin-bottom: 15px; text-transform: capitalize;"><a href="update_group.php?team=<?php echo $team_id ?>" style="text-decoration: none;">edit team info</a></h4>
