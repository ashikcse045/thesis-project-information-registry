                ...
                <div class="form_div">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="fields radio">
                            ...
                            <br>
                            <input type="radio" name="catagory" id="thesis" value="thesis" <?php if (isset($catagory)) {
                                if ($catagory == 'thesis') {
                                    echo 'checked';
                                }
                            } ?>>
                            ...
                            <br>
                            <input type="radio" name="catagory" id="project" value="project" <?php if (isset($catagory)) {
                                if ($catagory == 'project') {
                                    echo 'checked';
                                }
                            } ?>>
                        ...
                        <div class="fields dates">
                            ...
                            <div class="select-box">
                                <select name="s_sName" id="">
                                    ...
                                    <option value="spring" <?php if (isset($s_sName)) {
                                        if ($s_sName == 'spring') {
                                            echo 'selected';
                                        }
                                    } ?>>Spring
                                    </option>
                                    <option value="summer" <?php if (isset($s_sName)) {
                                        if ($s_sName == 'summer') {
                                            echo 'selected';
                                        }
                                    } ?>>Summer
                                    </option>
                                    <option value="fall" <?php if (isset($s_sName)) {
                                        if ($s_sName == 'fall') {
                                            echo 'selected';
                                        }
                                    } ?>>fall
                                ...
                                <select name="s_sYear" id="">
                                    ...
                                    for ($i = $c_year; $i >= $c_year - 3; $i--) {
                                        ?>
                                        <option value="<?php echo $i ?>" <?php if (isset($s_sYear)) {
                                               if ($s_sYear == $i) {
                                                   echo 'selected';
                                               }
                                           } ?>>
                        ...
                        <div class="fields">
                            <button name="view" style="padding: 10px 15px; cursor: pointer;"><b>Old file:
                                </b><i><?php echo $old_file; ?></i></button>
                        </div>
